...
class OpponentsPaddleSlownessPower extends PaddlePower
{
    ...
    public void updateForNewFrame()
    {
        ...
        if (this.hitsRightPaddle())
        {
            ...
            PowerTimer.leftPaddlePowers.put("opponents-paddle-slowness-power", this);
        }
        else if (this.hitsLeftPaddle())
        {
            ...
            this.side = "right";
            this.initTime = System.currentTimeMillis();
            PowerTimer.rightPaddlePowers.put("opponents-paddle-slowness-power", this);
        }
    }
